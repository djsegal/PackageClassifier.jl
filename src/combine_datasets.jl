function combine_datasets(decibans_db, general_db)
    ...
    general_db = general_db[in.(lowercase.(general_db.package), Ref(lowercase.(decibans_db.package))) .== 0, :]

    return (decibans_db, general_db)
end
